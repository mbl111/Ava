...
namespace SpACraft
{
    ...
    public sealed partial class PlayerInfo : IClassy
    {
        ...
        public int ID;
        // this is why we were getting errors. I this wont be used for authing. we shall use passwords.
        // although there is a config option for authing. I suggest we add a password option so that both methods are avalible.
        ...
        public string ClassyName
        {
            get
            {
                ...
                if (ConfigKey.TitlesInChat.Enabled() && Title != null)
                {
