    ...
    public static class Logger
    {
                                             ...
                                             [CanBeNull] Exception exception, bool shutdownImminent)
        {
            ...
            lock (CrashReportLock)
            {
                ...
                try
                {
                    ...
                    sb.Append("version=").Append(Uri.EscapeDataString(SpACraft.version));
                    ...
                    request.UserAgent = "SpACraft " + SpACraft.version;
        ...
        public static bool CheckForCommonErrors([CanBeNull] Exception ex)
        {
            ...
            try
            {
                ...
                {
                    message = "SpACraft could not locate Mono's compression functionality. " +
                ...
                {
                    message = "Something is incompatible with the current revision of SpACraft. " +
                ...
                {
                    message = "SpACraft was blocked from accessing a file or resource. " +
                              "Make sure that correct permissions are set for the SpACraft files, folders, and processes.";
                    return true;

                }
                else if (ex is OutOfMemoryException)
                {
                    message = "SpACraft ran out of memory. Make sure there is enough RAM to run.";
                    return true;
                ...
                {
                    message = "Some Windows settings are preventing SpACraft from doing player name verification. " +
                ...
                {
                    message = "A filesystem-related error has occured. Make sure that only one instance of SpACraft is running, " +
        ...
        internal static void PrepareEventTracing() {
            ...
            var asmName = new AssemblyName( "SpACraftEventTracing" );
